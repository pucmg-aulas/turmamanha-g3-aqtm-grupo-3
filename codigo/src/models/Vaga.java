...
public abstract class Vaga {
    ...
    private Historico historico;  // Composição: Vaga controla o ciclo de vida do HistoricoOcupacao

    public Vaga(String id) {
        this.id = id;
        this.ocupada = false;
        this.historico = new Historico();  // Composição: Vaga cria o histórico no momento de sua criação
    }
    ...
    public void ocupar(Veiculo veiculo) {
        ...
        historico.entrada(veiculo);  // Atualiza o histórico quando a vaga é ocupada
    }
