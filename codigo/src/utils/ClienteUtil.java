...
public class ClienteUtil {
    ...
    // Método para salvar os clientes em um arquivo de texto
    public static void salvarClientesNoArquivo(String caminho, List<Cliente> clientes) throws IOException {
        salvarClientesEmArquivo(caminho, clientes);
    }
}
